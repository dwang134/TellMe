...
const History = ({transactions}) => {
  ...
  return (
    ...
    <div className= 'grid gap-4'>
    {
      ...
      <BiTrash data-id= {transaction.id} className='w-2/12 px-3 text-lg hover:cursor-pointer' onClick= {handleDelete} style= {{color: transaction.color}}></BiTrash>
      <div className= 'w-full h-fit  text-center'>{transaction.desc}</div>
